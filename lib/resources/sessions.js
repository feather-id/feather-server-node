...
// TODO map /list to a list of session
...
function mapToSession(res) {
  if (!res || res.object != "session") {
  ...
  return {
    ...
    revokedAt: res.revoked_at ? Date.parse(res.revoked_at) : null
  };
}
